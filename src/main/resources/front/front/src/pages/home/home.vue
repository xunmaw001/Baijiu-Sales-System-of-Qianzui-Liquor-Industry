...
<div class="home-preview" :style='{"width":"100%","padding":"10px 20px 0","margin":"20px 0 0","flexWrap":"wrap","justifyContent":"center","display":"block"}'>
	<el-row type="flex" :gutter="5" justify="center" style="width: 100%">
		...
		<el-col :span="3" v-if="queryIndex==0">
			<el-input v-model="remaijiushuijiushuimingcheng" placeholder="酒水名称"></el-input>
		</el-col>
		<el-col :span="3" v-if="queryIndex==0">
			<el-button type="primary" @click="search('remaijiushui')">搜索</el-button>
		</el-col>
	</el-row>
...
<div class="recommend" :style='{"border":"0px solid #dfdfdf","boxShadow":"0px 0px 0px #eee","padding":"0","margin":"20px auto","borderColor":"#98c6e2","display":"flex","overflow":"hidden","borderRadius":"0","flexWrap":"wrap","background":"none","borderWidth":"0 0 8px","width":"100%","position":"relative","borderStyle":"dotted","height":"auto"}'>
    ...
    <div class="title" :style='{"padding":"0","margin":"30px auto 20px","borderRadius":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230101/6c449007e7a54a8892733c2b466c35cb.png) no-repeat center top","width":"100%","lineHeight":"56px","position":"relative","height":"56px"}'>
		<span :style='{"padding":"0","margin":"0 auto","color":"#fff","background":"nonr","display":"inline-block","fontSize":"24px","textShadow":"0px 0px 0px #eee"}'>热卖酒水推荐</span>
	</div>
	...
	<div class="list list1 index-pv1" :style='{"padding":"0 10px","margin":"0px auto","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"padding":"10px","boxShadow":"0px 0px 4px #eee","margin":"10px","borderColor":"#eee","borderRadius":"0px","background":"#fff","borderWidth":"1px","display":"inline-block","width":"23%","position":"relative","borderStyle":"solid","height":"auto"}' v-for="(item,index) in remaijiushuiRecommend" :key="index" @click="toDetail('remaijiushuiDetail', item)" class="list-item animation-box">
			<img :style='{"cursor":"pointer","boxShadow":"0px 0px 0px #ddd","padding":"10px","borderColor":"#9dcde9","objectFit":"cover","borderRadius":"0","borderWidth":"4px","background":"#fff","display":"block","width":"100%","borderStyle":"dotted","height":"240px"}' v-if="preHttp(item.fengmian)" :src="item.fengmian.split(',')[0]" alt="" />
	...
	<div @click="moreBtn('remaijiushui')" :style='{"border":"0px solid #ffa100","cursor":"pointer","boxShadow":"0px 0px 0px #ddd5c6,inset 0px 0px 0px 0px #ffa100","padding":"0 20px","margin":"20px auto 40px","borderColor":"#9dcde9","textAlign":"center","display":"block","borderRadius":"0px","background":"#fff","borderWidth":"8px 0px 6px 0px","width":"130px","lineHeight":"40px","borderStyle":"dotted"}'>
...
<div class="lists" :style='{"padding":"0px","boxShadow":"0px 0px 0px #eee","margin":"20px auto 20px","borderColor":"#98c6e2","display":"flex","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"none","borderWidth":"0 0 8px","width":"100%","position":"relative","borderStyle":"dotted","height":"auto","order":"8"}'>
	...
	<div class="title" :style='{"padding":"0","margin":"30px auto 30px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230101/6c449007e7a54a8892733c2b466c35cb.png) no-repeat center top","width":"100%","lineHeight":"56px","position":"relative","height":"56px"}'>
	  <span :style='{"padding":"0","fontSize":"24px","color":"#fff","textShadow":"0px 0px 0px #eee","background":"none"}'>热卖酒水展示</span>
	</div>
	...
	<div class="list list2 index-pv1" :style='{"width":"100%","padding":"0 10px","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
		<div :style='{"padding":"10px","boxShadow":"0px 0px 4px #eee","margin":"10px","borderColor":"#eee","display":"flex","flexWrap":"wrap","background":"#fff","borderWidth":"1px","width":"48%","fontSize":"0","position":"relative","borderStyle":"solid","height":"240px"}' v-for="(item,index) in remaijiushuiList" class="list-item animation-box" :key="index" @click="toDetail('remaijiushuiDetail', item)">
			<img :style='{"cursor":"pointer","padding":"10px","borderColor":"#9dcde9","objectFit":"cover","borderWidth":"4px","display":"inline-block","width":"48%","borderStyle":"dotted","height":"100%"}' v-if="preHttp(item.fengmian)" :src="item.fengmian.split(',')[0]" alt="" />
			<img :style='{"cursor":"pointer","padding":"10px","borderColor":"#9dcde9","objectFit":"cover","borderWidth":"4px","display":"inline-block","width":"48%","borderStyle":"dotted","height":"100%"}' v-else :src="baseUrl +  (item.fengmian?item.fengmian.split(',')[0]:'')" alt="" />
			<div :style='{"width":"48%","padding":"0px 10px","overflow":"hidden","display":"inline-block","height":"100%"}' class="item-info">
				<div class="name line1" :style='{"padding":"0 10px","borderColor":"#9dcde9","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderWidth":"0 0 2px","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dotted"}'>{{item.jiushuimingcheng}}</div>
				<div class="name line1" :style='{"padding":"0 10px","borderColor":"#9dcde9","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderWidth":"0 0 2px","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dotted"}'>{{item.pinpai}}</div>
				<div class="name line1" :style='{"padding":"0 10px","borderColor":"#9dcde9","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","borderWidth":"0 0 2px","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dotted"}'>{{item.chandi}}</div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('remaijiushui')" :style='{"cursor":"pointer","margin":"20px auto 40px","borderColor":"#9dcde9","borderRadius":"0px","textAlign":"center","background":"#fff","borderWidth":"8px 0px 6px 0px","display":"block","width":"auto","lineHeight":"40px","borderStyle":"dotted"}'>
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryIndex: 0,
        remaijiushuijiushuimingcheng: '',
        newsList: [],
        remaijiushuiRecommend: [],
    ...
    methods: {
      ...
      search(tablename) {
        if (this.queryIndex == 0 && this.remaijiushuijiushuimingcheng) {
          this.$router.push({path: '/index/' + tablename, query: {indexQueryCondition: this.remaijiushuijiushuimingcheng}});
        }
      },
		getNewsList() {
		...
		getList() {
          let autoSortUrl = "";
          autoSortUrl = "remaijiushui/autoSort";
          if(localStorage.getItem('Token')) {
              autoSortUrl = "remaijiushui/autoSort2";
          }
			this.$http.get(autoSortUrl, {params: {
				...
				if (res.data.code == 0) {
					this.remaijiushuiRecommend = res.data.data.list;
			...
			this.$http.get('remaijiushui/list', {params: {
				page: 1,
				limit: 6,
			}}).then(res => {
				if (res.data.code == 0) {
					this.remaijiushuiList = res.data.data.list;

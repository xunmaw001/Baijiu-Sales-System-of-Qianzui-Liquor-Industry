<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="酒水类型" prop="jiushuileixing">
					<el-input v-model="ruleForm.jiushuileixing" placeholder="酒水类型" clearable  :readonly="ro.jiushuileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="酒水类型" prop="jiushuileixing">
					<el-input v-model="ruleForm.jiushuileixing" placeholder="酒水类型" readonly></el-input>
				</el-form-item>
			</template>
